...
public class GameGoods extends GameObject{
	...
	public boolean isCollide(GameObject obj) {
		// 矩形1位于矩形2的左侧
		if (object_x <= (obj.getObject_x()+obj.object_width/5)
				&& object_x + object_width <= (obj.getObject_x()+obj.object_width/3)) {
			return false;
		}
		// 矩形1位于矩形2的右侧
		else if (obj.getObject_x()-obj.object_width/5 <= object_x
				&& obj.getObject_x() + obj.getObject_width()-obj.object_width/3 <= object_x) {
			return false;
		}
		// 矩形1位于矩形2的上方
		else if (object_y <= obj.getObject_y()+object_height/5
				&& object_y + object_height <= obj.getObject_y()+object_height/3) {
			return false;
		}
		// 矩形1位于矩形2的下方
		else if (obj.getObject_y()-object_height/5 <= object_y
				&& obj.getObject_y() + obj.getObject_height() <= object_y-object_height/3 ) {
			return false;
		}
		isAlive = false;
		return true;
